...

{
    ...
    clsString String2("Omar");

    String1.Value = "Ahmed Ali";
    ...
    cout << "Number of words: " << String1.CountWords("Omar Mushref") << endl;

    cout << "Number of words: " << clsString::CountWords("Ahmad Mohammad Mahmoud") << endl;
